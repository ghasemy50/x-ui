...
```
bash <(curl -Ls https://raw.githubusercontent.com/ghasemy50/x-ui/master/install.sh)
```
## Manual installation & upgrade

1. First download the latest compressed package from https://github.com/ghasemy50/x-ui/releases, generally choose the `amd64` architecture
2. Then upload this compressed package to the server's `/root/` directory and log in to the server as the `root` user
...
[![Stargazers over time](https://starchart.cc/ghasemy50/x-ui.svg)](https://starchart.cc/ghasemy50/x-ui)
